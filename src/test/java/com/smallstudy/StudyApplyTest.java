...
public class StudyApplyTest {
    ...
    * */
    ...
    private static Long STUDY_WITH_FORM_ID;
    private static Long STUDY_NO_FORM_ID;
    private static Long FORM_ID;
    ...
    private StudyFormDTO getStudyFormDTO(Long studyId) {
